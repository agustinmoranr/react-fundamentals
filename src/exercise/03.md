...
The following elements are strongly the same
...
JSX elements are objects and react uses these objects to build the DOM and keep
it up to date.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=agustin.moranr%40gmail.com).
